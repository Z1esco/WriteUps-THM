...
The scan results indicated that port 22 (SSH) and port 80 (HTTP) were open. Upon navigating to the web server, a static, clue-free landing page was observed.
![](https://i.imgur.com/KI9a7fi.png)

I proceeded to the web page and was greeted by a static, clue-free page.
